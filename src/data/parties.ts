...
export const parties: Party[] = [
  ...
  { id: 'NORTH BENGAL PEOPLES PARTY', name: 'North Bengal Peoples Party', nameBn: 'উত্তরবঙ্গ পিপলস পার্টি',      abbreviation: 'NBPP',    color: '#37474F', isNational: false },
  ...
  { id: 'BHUMIPUTRA UNITED PARTY', name: 'Bhumiputra United Party',  nameBn: 'ভূমিপুত্র ইউনাইটেড পার্টি',          abbreviation: 'BUP',     color: '#33691E', isNational: false },
  { id: 'GURUCHAND SENA DAL',      name: 'Guruchand Sena Dal',       nameBn: 'গুরুচাঁদ সেনা দল',                  abbreviation: 'GSD',     color: '#827717', isNational: false },
  { id: 'RASTRIYA AAM JAN SEVA PARTY', name: 'Rastriya Aam Jan Seva Party', nameBn: 'রাষ্ট্রীয় আম জন সেবা পার্টি', abbreviation: 'RAJSP', color: '#558B2F', isNational: false },
  { id: 'BHARTIYA LOKMAT RASHTRAWADI PARTY', name: 'Bhartiya Lokmat Rashtrawadi Party', nameBn: 'ভারতীয় লোকমত রাষ্ট্রবাদী পার্টি', abbreviation: 'BLRP', color: '#6A1B9A', isNational: false },
  { id: 'BHARTIYA RASHTRIYA DAL',  name: 'Bhartiya Rashtriya Dal',   nameBn: 'ভারতীয় রাষ্ট্রীয় দল',              abbreviation: 'BRD',     color: '#F57F17', isNational: false },
  { id: 'JAMAT-E-SERATUL MUSTAKIM', name: 'Jamat-e-Seratul Mustakim', nameBn: 'জামাত-ই-সেরাতুল মুস্তাকিম',       abbreviation: 'JSM',     color: '#1B5E20', isNational: false },
