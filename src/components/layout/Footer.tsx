    ...
    <footer className="mt-16 border-t border-gray-200 bg-gray-50 pb-20 md:pb-0">
      <div className="mx-auto max-w-7xl px-4 py-10">
        <div className="grid gap-8 md:grid-cols-3">
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              {[
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className="inline-block py-1 transition-colors duration-150 hover:text-blue-600 active:text-blue-700"
                  >
                    {label}
                  </Link>
                </li>
          ...
          {/* Official Sources */}
          <div>
            <h3 className="mb-3 text-sm font-semibold text-gray-900">Official Sources</h3>
            <ul className="space-y-1 text-sm text-gray-600">
              {[
                ...
                <li key={href}>
                  <a
                    ...
                    className="inline-flex items-center gap-1 py-1 transition-colors duration-150 hover:text-blue-600 active:text-blue-700"
                  >
        ...
        <div className="flex items-center justify-center gap-1" role="list" aria-label="Developer contact">
          <a
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full text-gray-400 transition-all duration-150 hover:text-gray-600 active:scale-95 active:text-gray-700 active:bg-gray-100"
          >
